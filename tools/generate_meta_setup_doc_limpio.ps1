...
$docPath = Join-Path (Get-Location) 'PASO_A_PASO_META_FACEBOOK_INSTAGRAM_CRM_LIMPIO.docx'
...
$parts.Add((P 'Este documento indica qu?? debe configurar la persona que administra Meta Business/Meta Developers para que el CRM local HPD pueda recibir y gestionar WhatsApp, Facebook e Instagram. WhatsApp ya est?? configurado; Facebook e Instagram requieren productos, permisos, OAuth y webhooks adicionales.'))
...
$parts.Add((Bullet 'La P??gina de Facebook debe estar dentro del Business Manager correcto.'))
$parts.Add((Bullet 'La cuenta de Instagram debe ser profesional: Business o Creator.'))
$parts.Add((Bullet 'Instagram debe estar vinculado a la P??gina de Facebook.'))
$parts.Add((Bullet 'El usuario que har?? la configuraci??n debe tener permisos de administrador sobre la empresa, la P??gina, Instagram y la App de Meta.'))
$parts.Add((Bullet 'La App de Meta debe ser la misma o una App relacionada a la operaci??n del CRM. Si hoy solo tiene WhatsApp, hay que agregar productos adicionales.'))

$parts.Add((P '2. Mantener WhatsApp como est??' 'Heading1'))
...
$parts.Add((CodeLine 'Verify Token: el mismo valor que se colocar?? en CRM > conexiones > WhatsApp > Webhook Verify Token'))
...
$parts.Add((P 'En la App de Meta Developers, agregar o configurar estos productos seg??n aparezcan disponibles:'))
$parts.Add((Bullet 'Facebook Login for Business o Facebook Login: necesario para iniciar sesi??n/OAuth y autorizar permisos.'))
$parts.Add((Bullet 'Webhooks: necesario para recibir eventos de Facebook e Instagram.'))
$parts.Add((Bullet 'Messenger: necesario para mensajes de la P??gina de Facebook.'))
$parts.Add((Bullet 'Instagram / Instagram Messaging / Instagram Graph API: necesario para mensajes, comentarios e informaci??n de Instagram.'))
...
$parts.Add((P 'Tambi??n revisar App Domains. Si Meta lo pide, agregar:'))
...
$parts.Add((CodeLine 'Verify Token: el mismo valor que se pondr?? en CRM > conexiones > Instagram/Facebook > Meta Webhook Verify Token'))
$parts.Add((P 'Suscribir la App a los objetos/campos que Meta permita para la App:'))
$parts.Add((Bullet 'Para Facebook Page/Messenger: mensajes, eventos de messaging, comentarios/feed, metadata de p??gina.'))
...
$parts.Add((Bullet 'En modo desarrollo solo funcionar?? con usuarios, p??ginas y cuentas autorizadas/testers. Para producci??n, Meta puede pedir revisi??n de permisos.'))
...
$parts.Add((P '8. Probar conexi??n desde el CRM' 'Heading1'))
...
$parts.Add((Bullet 'Aceptar permisos con un usuario administrador del Business/P??gina.'))
$parts.Add((Bullet 'Volver al CRM y verificar que el canal aparezca conectado o que indique ??nicamente permisos pendientes.'))
...
$parts.Add((Bullet 'Hacer un comentario de prueba en una publicaci??n si se activaron comentarios.'))
$parts.Add((Bullet 'Confirmar que Meta env??a eventos al webhook del CRM.'))
$parts.Add((Bullet 'Confirmar que el CRM crea conversaci??n con canal FACEBOOK o INSTAGRAM.'))
...
$parts.Add((Bullet 'Para producci??n conviene usar Cloudflare Tunnel o dominio fijo.'))
...
$parts.Add((Bullet 'Agregar Messenger si se manejar??n mensajes de Facebook.'))
...
$parts.Add((Bullet 'Suscribir eventos de mensajes, comentarios e insights seg??n permisos.'))
