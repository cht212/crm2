...
const suggestionGroups: SuggestionGroup[] = [
  {
    ...
    content: [
      { icon: 'ri-bar-chart-line', title: 'Analítica', url: { name: 'dashboards-analytics' } },
      { icon: 'ri-pie-chart-2-line', title: 'CRM', url: { name: 'dashboards-crm' } },
      { icon: 'ri-shopping-bag-3-line', title: 'Comercio electrónico', url: { name: 'dashboards-ecommerce' } },
      { icon: 'ri-car-line', title: 'Logística', url: { name: 'apps-logistics-dashboard' } },
    ],
  },
  {
    title: 'Aplicaciones y páginas',
    content: [
      { icon: 'ri-calendar-line', title: 'Calendario', url: { name: 'apps-calendar' } },
      { icon: 'ri-lock-unlock-line', title: 'Roles y permisos', url: { name: 'apps-roles' } },
      { icon: 'ri-settings-4-line', title: 'Configuración de la cuenta', url: { name: 'pages-account-settings-tab', params: { tab: 'account' } } },
      { icon: 'ri-file-copy-line', title: 'Ejemplos de diálogos', url: { name: 'pages-dialog-examples' } },
    ],
  },
  {
    title: 'Interfaz de usuario',
    content: [
      { icon: 'ri-text', title: 'Tipografía', url: { name: 'pages-typography' } },
      { icon: 'ri-menu-line', title: 'Acordeón', url: { name: 'components-expansion-panel' } },
      { icon: 'ri-alert-line', title: 'Alertas', url: { name: 'components-alert' } },
      { icon: 'ri-checkbox-blank-line', title: 'Tarjetas', url: { name: 'pages-cards-card-basic' } },
    ],
  },
  {
    title: 'Formularios y tablas',
    content: [
      { icon: 'ri-radio-button-line', title: 'Selector', url: { name: 'forms-radio' } },
      { icon: 'ri-file-text-line', title: 'Diseños de formularios', url: { name: 'forms-form-layouts' } },
      { icon: 'ri-table-line', title: 'Tabla', url: { name: 'tables-simple-table' } },
