...
<template>
  <IconBtn id="notification-btn">
    <VBadge
      ...
      :content="totalUnreadNotifications"
      :max="99"
      color="error"
      bordered
      offset-x="1"
    ...
    >
      <VCard class="d-flex flex-column">
        ...
        <VCardItem class="notification-section">
          <h6 class="text-h6 text-truncate">Notificaciones</h6>
          ...
          <template #append>
            ...
            >
              ...
              {{ totalUnreadNotifications === 1 ? "nuevo" : "nuevos" }}
            </VChip>
        ...
        >
          <VList class="py-0">
              ...
              >
                ...
                <div class="d-flex align-start gap-3">
                  ...
                  <div>
                    ...
                    <p
                      class="text-caption notification-summary mb-2 text-medium-emphasis"
                      style="
            ...
            >
              <VListItemTitle
                >¡No se encontraron notificaciones!</VListItemTitle
              >
            </VListItem>
          </VList>
        </PerfectScrollbar>
